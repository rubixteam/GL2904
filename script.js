...
////////////////////////////////////Envoi de la requete//////////////////////////////////////////////
		...
		xmlHttpRequest.open("GET", "inscription.php?verif=true&login="+loginRec, true);//etat : 1
...
function checkValidate(){
	...
	if (checkStateRec == "true"){
		...
		xmlHttpRequest.open("GET", "inscription.php?verif=false&login="+loginRec+"&pwd="+pwdRec, true);
        xmlHttpRequest.send(null); 
/////////////////////////////Pour définir le traitement de la réponse du serveur///////////////////////		
        xmlHttpRequest.onreadystatechange = validateResponse;
    }		
	}else{
		alert('Responsable Existant');
	}
}
